...
export async function generateMetadata() {
  const title = "스포트라이트 | 상업 촬영을 위한 전문 플랫폼";
  const description = "박준우(Park Jun Woo) 한국|Korea";
  const metadataBase = new URL("https://spotlite.global/");
  const openGraph = {
    title,
    description,
    url: "https://spotlite.global/",
